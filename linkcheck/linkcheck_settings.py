...
RECHECK_INTERVAL = getattr(settings, 'LINKCHECK_RECHECK_INTERVAL', 10080) # 1 week
...
GOOGLE_API_KEY = getattr(settings, 'LINKCHECK_GOOGLE_API_KEY', None)
GOOGLE_CX = getattr(settings, 'LINKCHECK_GOOGLE_CX', None)
MAX_SUGGESTIONS_PER_RUN = getattr(settings, 'LINKCHECK_MAX_SUGGESTIONS_PER_RUN', 100)